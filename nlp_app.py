...
def main():
    ...
    if choice == "Home":
        ...
        st.write("Sample Dataset [@rupak-roy Github](https://github.com/rupak-roy/dataset-streamlit) V3 update: Deep Learning module at [@streamlit] (https://share.streamlit.io/rupak-roy/streamlit_deeplearning_analytics/main/ML.py"))
